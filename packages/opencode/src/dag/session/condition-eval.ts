...
/**
 * WP-B2: Condition evaluation — pure function module.
 *
 ...
 * - Only imports from `./types` (DAGNodeCondition, DAGNodeSession)
 *
...
export function evaluateCondition(
  ...
  const output = outputMap.get(condition.ref_node) ?? null
