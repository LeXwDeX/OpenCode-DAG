...
export namespace Tool {
  ...
  export interface Def<Parameters extends z.ZodType = z.ZodType, M extends Metadata = Metadata> {
    ...
    /** Whether this tool can execute concurrently with other concurrent-safe tools. Default: false (fail-closed). */
    concurrency?: boolean
    /** Whether this tool performs only read operations. Default: false (fail-closed). */
    readonly?: boolean
    /** Whether this tool performs irreversible/destructive operations. Default: false. */
    destructive?: boolean
  }
