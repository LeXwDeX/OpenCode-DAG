  ...
  describe("latest", () => {
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(npmCalls.some((url) => url.includes(`/opencode-ai/${InstallationChannel}`))).toBe(true)
      }),
    )
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(bunCalls.some((url) => url.includes(`/opencode-ai/${InstallationChannel}`))).toBe(true)
      }),
    )
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(pnpmCalls.some((url) => url.includes(`/opencode-ai/${InstallationChannel}`))).toBe(true)
      }),
    )
